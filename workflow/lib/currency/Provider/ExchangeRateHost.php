...
/**
 * Get exchange rates from https://exchangerate.host/
 */
class ExchangeRateHost implements ProviderInterface
{
    /**
     ...
     * @var string
     */
    public const EXCHANGERATEHOST_API_BASEPATH = 'https://api.exchangerate.host/latest';
    ...
    {
        $path = sprintf(
            self::EXCHANGERATEHOST_API_BASEPATH . '?symbols=%s&base=%s',
            $toCurrency,
            $fromCurrency
        );
